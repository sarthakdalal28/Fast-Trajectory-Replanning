...
def reconstruct(curr):
    ...
    print("Length of path to be traversed: ", len(path))
    return path[::-1]
...
if __name__ == '__main__':
    ...
    gval, start_node, all_nodes = ComputePath(pos_t_x, pos_t_y, open, closed, direc, count, grid, gval, goal_node, pathcost, deltah, all_nodes)
    ans = reconstruct(start_node)
    print(ans)
    end = time.time()
